...
public class Test1 {
	public static void main( String[] args ) throws InterruptedException
	{
        ...
        driver.findElement(By.xpath("//*[@id=\"first-name\"]")).sendKeys("KARTHIK");
        driver.findElement(By.xpath("//*[@id=\"last-name\"]")).sendKeys("M P");
        driver.findElement(By.xpath("//*[@id=\"postal-code\"]")).sendKeys("639111");
